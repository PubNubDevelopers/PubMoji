                 ...
                 <Marker key={index} coordinate={{latitude: item.coords[0], longitude: item.coords[1]}}>
                    {
                      function() {
                          ...
                          for(let i = 0 ; i < item.emoji; i++){
                            rows.push(<Animatable.View style={styles.marker} animation="fadeOutUp" duration={1000} iterationCount={1} direction="normal" easing = "ease-out" onAnimationEnd = {() => this.killEmoji()} key = {i}>
